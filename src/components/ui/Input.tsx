...
export default function Input({
  ...
  // Estilos del label
  const labelStyles = 'block text-sm font-medium text-contrast font-body';
  ...
  const stateStyles = hasError
    ...
    : 'border-base/30 focus:border-primary focus:ring-2 focus:ring-primary/20';
  ...
  const helperTextStyles = 'text-xs text-depth mt-1';

  // Estilos del mensaje de error
  const errorStyles = 'text-xs text-danger font-medium mt-1 flex items-center gap-1';
